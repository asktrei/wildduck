            ...
            let profile = await mobileconfigGetSignedConfig(
                {
                    ...
                    PayloadDisplayName: 'GMI Mail',
                    // PayloadDescription: profileOpts.displayDescription,
                    PayloadDescription: 'Install this profile to setup ' + accountAddress,
                    PayloadOrganization: 'GMI Mail Service',
                    ...
                    PayloadContent: [
                        {
                            ...
                            // PayloadOrganization: profileOpts.organization || 'GMI Mail Server',
                            PayloadOrganization: 'GMI Mail Service',

                            // EmailAccountDescription: profileOpts.accountDescription,
                            EmailAccountDescription: 'GMI MAIL (' + accountAddress + ')',
